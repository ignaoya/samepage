...
class Story(Resource):
    ...
    parser.add_argument('origin', type=str, required=True, help="This field cannot be empty.")
    parser.add_argument('link', type=str, required=True, help="This field cannot be empty.")
    parser.add_argument('event_id', type=int, required=True, help="This field cannot be empty.")
